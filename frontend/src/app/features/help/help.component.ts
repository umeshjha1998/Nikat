...
@Component({
  ...
  styles: [`
    ...
    .help-page-premium { min-height: 100vh; background: var(--bg); color: var(--text-main); scroll-behavior: smooth; }

    /* Nav */
    .help-nav { height: 5rem; background: var(--surface-container); backdrop-filter: blur(20px); border-bottom: 1px solid var(--glass-border); position: sticky; top: 0; z-index: 1000; }
    ...
    .brand { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 1.5rem; font-weight: 800; color: var(--text-main); text-decoration: none; display: flex; align-items: center; gap: 0.5rem; }
    ...
    .btn-hub { background: var(--glass); border: 1px solid var(--glass-border); padding: 0.6rem 1.25rem; border-radius: 1rem; color: var(--text-main) !important; }
    ...
    .help-search-premium input { flex: 1; background: transparent; border: none; color: var(--text-main); font-size: 1.15rem; outline: none; padding: 0.75rem 0; font-family: 'Manrope', sans-serif; }
    .help-search-premium kbd { background: var(--surface-container); padding: 0.4rem 0.75rem; border-radius: 0.5rem; font-size: 0.75rem; font-weight: 800; color: var(--text-muted); margin-right: 1rem; }

    .hero-bg-glow { position: absolute; width: 600px; height: 600px; background: radial-gradient(circle, var(--accent-glow), transparent 70%); top: -100px; left: 50%; transform: translateX(-50%); filter: blur(80px); }
    ...
    .topic-card-premium {
      background: var(--surface-container-low); border: 1px solid var(--glass-border); border-radius: 2rem; padding: 2.5rem;
      text-align: left; transition: 0.3s cubic-bezier(0.25, 0.8, 0.25, 1);
      box-shadow: 0 10px 30px rgba(0,0,0,0.1);
    }
    .topic-card-premium:hover { border-color: var(--primary); transform: translateY(-8px); background: var(--surface-container); }
    ...
    .topic-card-premium h3 { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 1.25rem; color: var(--text-main); margin-bottom: 1rem; }
    ...
    .tag { font-size: 0.75rem; font-weight: 900; color: var(--primary); text-transform: uppercase; letter-spacing: 0.1em; background: var(--accent-glow); padding: 0.4rem 1rem; border-radius: 2rem; margin-bottom: 1rem; display: inline-block; }
    ...
    .faq-item-premium:hover { border-color: var(--outline-variant); }
    .faq-item-premium.open { border-color: var(--primary); background: var(--accent-glow); }
    .faq-q { padding: 1.5rem 2rem; display: flex; justify-content: space-between; align-items: center; }
    .faq-q h4 { font-size: 1.15rem; font-weight: 700; color: var(--text-main); margin: 0; }
    .q-toggle { width: 32px; height: 32px; border-radius: 50%; background: var(--surface-container); display: flex; align-items: center; justify-content: center; transition: 0.3s; }
    ...
    .btn-prime-glow {
      ...
      font-weight: 800; font-size: 1.1rem; cursor: pointer; box-shadow: 0 10px 40px var(--accent-glow);
    }

    .cb-channels { display: flex; flex-direction: column; gap: 2.5rem; }
    .chan { display: flex; align-items: center; gap: 1.5rem; }
    .chan .material-icons { font-size: 2rem; color: var(--primary); background: var(--accent-glow); width: 64px; height: 64px; border-radius: 1.5rem; display: flex; align-items: center; justify-content: center; }
    ...
    .help-footer p { color: var(--text-muted); font-size: 0.9rem; font-weight: 700; }
